...
export const th: Dictionary = {
    ...
    errors: {
        ...
        // เหตุผลที่พาเลทใบหนึ่งถูกข้ามในการบันทึกแบบกลุ่ม -- เป็นวลี ไม่ใช่ประโยค
        // เพราะ describeBulkFailures() เอาไปวางในวงเล็บหลังรหัสพาเลท
        bulkReason: {
            not_found: 'ไม่พบในระบบ',
            already_checked_out: 'ถูกเบิกออกไปแล้ว',
            not_checked_out: 'อยู่ในคลังอยู่แล้ว',
            damaged: 'แจ้งชำรุดอยู่',
            scrapped: 'ถูกตัดออกจากระบบแล้ว',
            changed_by_other: 'สถานะเปลี่ยนระหว่างบันทึก',
    ...
    login: {
        // อยู่ใต้โลโก้ จึงไม่ต้องมีคำว่า NMT ซ้ำอีก
        brandTagline: 'ระบบจัดการพาเลท',
        title: 'เข้าสู่ระบบ',
        subtitle: 'กรอกรหัสพนักงานและรหัสผ่านเพื่อเริ่มใช้งาน',
        recoveryTitle: 'รีเซ็ตรหัสผ่าน',
        recoverySubtitle: 'กรอกรหัสพนักงานเพื่อเริ่มขั้นตอนรีเซ็ตรหัสผ่าน',
        // ช่องนี้ยังรับอีเมลได้อยู่ -- signIn() จะแปลงเป็น alias email
        // ให้เฉพาะตอนที่ข้อความไม่มี "@" เท่านั้น แต่ตั้งชื่อตามสิ่งที่
        // พนักงานทุกคนรู้จักจริง แทนที่จะบอกทั้งสองทาง
        identifierLabel: 'รหัสพนักงาน',
        identifierPlaceholder: 'EMP001',
        passwordLabel: 'รหัสผ่าน',
        capsLockOn: 'Caps Lock เปิดอยู่',
        // แทนที่คำอธิบาย "จดจำฉันไว้" เดิม -- ตอนนี้ไม่มีช่องนั้นแล้ว
        // (การจำรหัสผ่านเป็นหน้าที่ของเบราว์เซอร์) บรรทัดนี้จึงเป็นที่เดียว
        // ที่บอกอายุของเซสชัน เขียนเป็นฟังก์ชันเพื่อให้ตัวเลขมาจาก constants.ts
        sessionNotice: (idleMinutes: number, maxHours: number) =>
            `ระบบจะออกจากระบบให้อัตโนมัติเมื่อปิดเบราว์เซอร์ ไม่มีการใช้งานเกิน ${idleMinutes} นาที หรือครบ ${maxHours} ชั่วโมง`,
        ...
        signIn: 'เข้าสู่ระบบ',
        // บอกสิ่งที่ปุ่มทำจริง: ปุ่มนี้ส่งลิงก์ ไม่ได้รีเซ็ตรหัสผ่านเอง
        ...
        tooManyAttempts: 'พยายามหลายครั้งเกินไป กรุณารอสักครู่แล้วลองใหม่',
    ...
    resetPassword: {
        ...
        samePassword: 'รหัสผ่านใหม่ต้องไม่ซ้ำกับรหัสผ่านเดิม กรุณาตั้งรหัสผ่านอื่น',
        weakPassword: 'รหัสผ่านนี้ไม่ผ่านเกณฑ์ความปลอดภัย กรุณาตั้งรหัสผ่านที่คาดเดายากกว่านี้',
        linkExpired: 'ลิงก์รีเซ็ตหมดอายุหรือถูกใช้ไปแล้ว กรุณาขอลิงก์ใหม่จากหน้าเข้าสู่ระบบ',
    ...
    scanError: {
        ...
        damaged: 'พาเลทชำรุด',
        alreadyCheckedOut: 'พาเลทถูกเบิกออกไปแล้ว',
        notCheckedOut: 'พาเลทอยู่ในคลังอยู่แล้ว',
