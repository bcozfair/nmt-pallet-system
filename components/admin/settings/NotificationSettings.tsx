        ...
        <Card as="section" className="p-5 sm:p-6">
            ...
            <div className="mt-5 flex flex-wrap items-end gap-4">
                ...
                {/* สองปุ่มยุบเป็นเมนูเดียว: การส่งทดสอบเป็นสิ่งที่นาน ๆ ทำที ปุ่มเต็ม
                    ...
                    ไม่ใช้ matchTriggerWidth แล้ว: พาเนลที่กว้างเท่าปุ่ม 96px จะเหลือที่
                    ให้ข้อความแค่ 22px หลังหัก p-1.5, px-3 ของรายการ และชิพไอคอน 28px
                    ป้าย "ส่งแจ้งเตือน" จะตัดบรรทัดจนอ่านไม่ได้ พาเนลจึงกลับไปใช้ความ
                    กว้างคงที่ของ Menu (256px)
