...
export const BUTTON_VARIANT: Record<ButtonVariant, string> = {
    ...
    // ปุ่มละลายไปกับพื้น รอบถัดมาลองขอบเข้ม `line-control` (3.45:1 ผ่านเกณฑ์)
    // แต่หน้าจอเต็มไปด้วยเส้น รอบถัดมาลองพื้นเทาอ่อน ซึ่งแย่กว่าเดิม: เทาอ่อนบนพื้น
    // หน้าจอ `--color-canvas` วัดได้ 1.03:1 -- จางกว่าตอนเป็นขอบอีก
    //
    ...
    // ระหว่างหน้าจอที่สะอาดกับตัวเลขที่ผ่าน -- ทางที่ผ่านคือกลับไปใช้ `line-control`
    secondary:
